...
\begin{table}[t]
  ...
  \resizebox{\linewidth}{!}{\input{paper_assets/table_actual_crypto_risk.tex}}
\end{table}
...
\begin{table}[t]
  ...
  \input{paper_assets/table_real_gradient_benchmark.tex}
\end{table}
...
\begin{table}[t]
  ...
  \label{tab:occupancy}
  \resizebox{\linewidth}{!}{\input{paper_assets/table_occupancy.tex}}
\end{table}
...
\begin{table}[t]
  ...
  \resizebox{\linewidth}{!}{\input{paper_assets/table_sgmcmc_diagnostics.tex}}
\end{table}
...
\begin{table}[t]
  ...
  \label{tab:stan-diag}
  \input{paper_assets/table_stan_diagnostics.tex}
\end{table}
